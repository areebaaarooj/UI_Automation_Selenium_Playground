...
- heading "Jquery Dropdown Search Demo" [level=1]
- text: "Drop Down with Search Select Country :"
- combobox "India"
- text: "Select Multiple Values with search Select State :"
- combobox:
  - list:
    - listitem "California": × California
    - listitem "Florida": × Florida
    - listitem:
      - textbox
- text: "Drop Down with Disabled values Select Country :"
- combobox "Puerto Rico"
- text: Drop-down with Category related options Select a file
- combobox "Select a file"
- contentinfo:
  ...
  - list:
    ...
    - listitem:
      - link "Coding Jag - Issue 257":
        - /url: /newsletter/editions/issue257
    - listitem:
